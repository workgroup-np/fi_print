...
function fi_print_widgets_init() {
		...
		register_sidebar( array(
				...
				'name'          => sprintf( __( 'Footer Sidebar %d', 'fi-print' ), 1 ),

				'id'            => 'fi_print-widgets-footer-block-1',
		...
		register_sidebar( array(
				...
				'name'          => sprintf( __( 'Footer Sidebar %d', 'fi-print' ), 2 ),

				'id'            => 'fi_print-widgets-footer-block-2',
		...
		register_sidebar( array(
				...
				'name'          => sprintf( __( 'Footer Sidebar %d', 'fi-print' ), 3 ),

				'id'            => 'fi_print-widgets-footer-block-3',
		...
		register_sidebar( array(
				...
				'name'          => sprintf( __( 'Footer Sidebar %d', 'fi-print' ), 4 ),

				'id'            => 'fi_print-widgets-footer-block-4',
...
if ( ! function_exists( 'fi_print_panels_row_container_start' ) ) {
	...
	function fi_print_panels_row_container_start( $grid, $attributes ) {
		...
		}if( isset( $attributes['style']['row_container']) && $attributes['style']['row_container']=='container' ){
